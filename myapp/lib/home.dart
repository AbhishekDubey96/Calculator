...
import 'package:myapp/app_constant.dart';
import 'package:myapp/home.dart';
import 'package:myapp/left_bar.dart';
import 'package:myapp/right_bar.dart';
...
setState(() {
  ...
  (_bmiResult>25){
    ...
    _textResult="You are Under weight";
      ...
      child: Container(
        child: Text("Calcultae",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,color:accentHexColor),) ,
      ),
    ),
